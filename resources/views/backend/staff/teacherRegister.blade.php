...
<div class="card card-style">
    ...
    @if(isset($data))
    <div class="input-style has-borders no-icon validate-field mb-4 col-sm-12">
    <input type="password" name="password" class="form-control validate-text" id="form2" placeholder="Password" hidden>
    @error('password')
    <div class="alert alert-danger">{{ $message }}</div>
    @enderror
...
<div class="input-style has-borders no-icon validate-field mb-4 col-sm-12">
    ...
    <input type="number" name="number" value="{{$data->mobile_number ??""}}" class="form-control validate-text" id="form44" placeholder="mobile number">
    @error('number')
    <div class="alert alert-danger">{{ $message }}</div>
    @enderror
