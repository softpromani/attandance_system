...
<img class="img-fluid" src="{{asset('frontend/assets/images/pictures/13.jpg')}}">
</div>
</div>
<div class="splide__slide">
<div class="card rounded-m shadow-l mx-3">
...
<div class="card-overlay bg-gradient"></div>
<img class="img-fluid" src="{{asset('frontend/assets/images/pictures/28.jpg')}}">
</div>
</div>
<div class="splide__slide">
<div class="card rounded-m shadow-l mx-3">
...
<div class="card-overlay bg-gradient"></div>
<img class="img-fluid" src="{{asset('frontend/assets/images/pictures/29.jpg')}}">
</div>
</div>
</div>
</div>
...
<a href="#" class="btn btn-m btn-center-l bg-highlight text-uppercase font-900 text-uppercase rounded-s shadow-xl mb-4">Swipe Left to Begin</a>
</div>
</div>
</div>
<div class="splide__slide">
...
<a href="#" class="btn btn-m btn-center-l bg-highlight text-uppercase font-900 text-uppercase rounded-s shadow-xl mb-4">Purchase today for $25</a>
</div>
</div>
</div>
</div>
...
<a href="#" class="btn btn-s btn-full text-uppercase font-900 bg-highlight rounded-s me-2 ms-2 mb-2">Purchase</a>
</div>
<div class="card-overlay bg-gradient"></div>
</div>
</div>
...
<a href="#" class="btn btn-m btn-center-l text-uppercase font-900 bg-highlight rounded-sm shadow-xl mt-4 mb-0">More Testimonials</a>
</div>
</div>
...
<a href="#" class="btn btn-m btn-center-l text-uppercase font-900 bg-highlight rounded-sm shadow-xl mb-4">Purchase Now - $25</a>
</div>
</div>
...
<img class="rounded-l mb-3" src="{{asset('frontend/assets/app/icons/icon-128x128.png')}}" alt="img" width="90">
